<h2><a href="https://www.geeksforgeeks.org/problems/delete-middle-of-linked-list/1?utm_medium=collab_striver_ytdescription&utm_campaign=delete-middle-of-linked-list&utm_source=youtube">Delete Middle of Linked List</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a singly linked list, delete the middle<strong>&nbsp;</strong>of the linked list.</span></p>
